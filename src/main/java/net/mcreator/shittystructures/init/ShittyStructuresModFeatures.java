...
import net.mcreator.shittystructures.world.features.FuckchestFeature;
...
public class ShittyStructuresModFeatures {
	...
	public static final RegistryObject<Feature<?>> FUCKCHEST = REGISTRY.register("fuckchest", FuckchestFeature::feature);
}
