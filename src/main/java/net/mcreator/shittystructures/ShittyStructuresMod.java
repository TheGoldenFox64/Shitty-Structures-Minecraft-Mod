 ...
 *
 */
package net.mcreator.shittystructures;
...
@Mod("shitty_structures")
public class ShittyStructuresMod {
	public static final Logger LOGGER = LogManager.getLogger(ShittyStructuresMod.class);
	public static final String MODID = "shitty_structures";

	public ShittyStructuresMod() {
