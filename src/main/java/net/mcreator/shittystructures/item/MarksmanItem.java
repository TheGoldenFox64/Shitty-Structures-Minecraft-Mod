...
public class MarksmanItem extends Item {
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
		...
		RevolverEntitySwingsItemProcedure.execute(entity.level, entity.getX(), entity.getY(), entity.getZ(), entity);
		return retval;
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MarksmanEntity entityarrow = MarksmanEntity.shoot(world, entity, world.getRandom(), 3f, 10, 5);
